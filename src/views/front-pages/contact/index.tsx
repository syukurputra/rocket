...
const ContactView = ({ mode }: { mode: SystemMode }) => {
  return (
      ...
      <div className={classnames('flex flex-col gap-14', frontCommonStyles.layoutSpacing)}>
          ...
          <Grid size={{ xs: 12, sm: 6, md: 4 }}>
            <Card className='text-center h-full'>
              <CardContent className='flex flex-col items-center gap-4 pbs-8 pbe-8'>
                ...
                <div className='flex flex-col gap-1'>
                  <Typography variant='h6' color='text.primary' className='font-semibold'>Alamat</Typography>
        ...
        <Card>
          <CardContent className='pli-8 plb-8'>
            <Typography variant='h5' color='text.primary' className='font-semibold mbe-4'>
              Jam Operasional
            </Typography>
